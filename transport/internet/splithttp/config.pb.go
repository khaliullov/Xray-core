...
type Config struct {
	...
	XPaddingField        string                 `protobuf:"bytes,14,opt,name=xPaddingField,proto3" json:"xPaddingField,omitempty"`
	XPaddingFiller       string                 `protobuf:"bytes,15,opt,name=xPaddingFiller,proto3" json:"xPaddingFiller,omitempty"`
	SessionNaming        string                 `protobuf:"bytes,16,opt,name=sessionNaming,proto3" json:"sessionNaming,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Config) GetXPaddingField() string {
	if x != nil {
		return x.XPaddingField
	}
	return ""
}

func (x *Config) GetXPaddingFiller() string {
	if x != nil {
		return x.XPaddingFiller
	}
	return ""
}

func (x *Config) GetSessionNaming() string {
	if x != nil {
		return x.SessionNaming
	}
	return ""
}
...
const file_transport_internet_splithttp_config_proto_rawDesc = "" +
	...
	"\x10hKeepAlivePeriod\x18\x06 \x01(\x03R\x10hKeepAlivePeriod\"\xd0\a\n" +
	"\x06Config\x12\x12\n" +
	...
	"\rxPaddingField\x18\x0e \x01(\tR\rxPaddingField\x12&\n" +
	"\x0exPaddingFiller\x18\x0f \x01(\tR\x0exPaddingFiller\x12$\n" +
	"\rsessionNaming\x18\x10 \x01(\tR\rsessionNaming\x1a:\n" +
